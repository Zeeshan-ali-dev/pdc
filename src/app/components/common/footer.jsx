        ...
        <footer className="md:pt-10 pt-0 mt-auto mb-0 bg-[#1C1D26] relative">
            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                        ...
                        <form className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none rounded-md border focus:border-indigo-600 shadow-sm"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4  text-sm text-center  bg-pdc-blue rounded-md text-white font-semibold uppercase  shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="flex-1 mt-16 grid grid-cols-3 justify-between sm:flex">
                    ...
                    <div  className="md:mt-[-32px] hidden md:block mt-0 w-[338px] h-[180px] p-[32px_42px] bg-[rgb(37,37,37,0.2)] rounded-[10px]">
                        <h4 className="text-[#FFF] font_cat text-[16px] not-italic font-bold leading-[28px] sm:pb-2">
                            Subscribe
                        </h4>
